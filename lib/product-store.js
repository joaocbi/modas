...
function normalizeImageList(value, fallbackImage) {
    ...
    return normalizedFallbackImage ? [normalizedFallbackImage] : ["/assets/ester01.png"];
}
...
function normalizeProduct(product, id) {
    ...
    return {
        ...
        strapShoulderOptions: normalizeArrayValue(product.strapShoulderOptions),
        fabricPatternOptions: normalizeArrayValue(product.fabricPatternOptions),
        ...
        image: normalizedImages[0] || "/assets/ester01.png",
